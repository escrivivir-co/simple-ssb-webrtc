...
module.exports = {
  fr: {
    ...
    webrtc: "WebRTC",
    webrtcTitle: "WebRTC",
    webrtcDescription: "Connexion pair-à-pair via signalisation par copier-coller. Partagez les codes avec votre pair par n'importe quel canal externe (chat, email, papier...).",
    webrtcStart: "Démarrer",
    webrtcStartDescription: "Choisissez de créer une nouvelle salle ou de rejoindre une existante.",
    webrtcModeLabel: "Mode : ",
    webrtcModeData: "Données uniquement (chat)",
    webrtcModeAV: "Appel Audio/Vidéo",
    webrtcCreateRoom: "Créer une Salle",
    webrtcJoinRoom: "Rejoindre une Salle",
    webrtcYourOfferCode: "Votre Code d'Offre",
    webrtcOfferCopy: "Copiez ce code et envoyez-le à votre pair :",
    webrtcCopyToClipboard: "Copier dans le Presse-papiers",
    webrtcPasteAnswer: "Collez maintenant le Code de Réponse de votre pair ci-dessous :",
    webrtcPasteAnswerPlaceholder: "Collez le code de réponse de votre pair ici...",
    webrtcConnect: "Connecter",
    webrtcJoinTitle: "Rejoindre une Salle",
    webrtcPasteOffer: "Collez le Code d'Offre reçu du créateur de la salle :",
    webrtcPasteOfferPlaceholder: "Collez le code d'offre ici...",
    webrtcGenerateAnswer: "Générer une Réponse",
    webrtcYourAnswerCode: "Votre Code de Réponse",
    webrtcAnswerCopy: "Copiez ce code et renvoyez-le au créateur de la salle :",
    webrtcWaitingConnection: "En attente de connexion...",
    webrtcMedia: "Médias",
    webrtcLocal: "Local",
    webrtcRemote: "Distant",
    webrtcMuteMic: "Couper le Micro",
    webrtcHideCam: "Masquer la Caméra",
    webrtcConnected: "Connecté",
    webrtcStatus: "Statut : ",
    webrtcDataChannel: "Canal de données : ",
    webrtcChat: "Chat par Canal de Données",
    webrtcTypePlaceholder: "Tapez un message...",
    webrtcSend: "Envoyer",
    webrtcDisconnect: "Déconnecter",
    ...
    modulesWebrtcDescription: "Module pour les connexions audio, vidéo et données pair-à-pair.",
