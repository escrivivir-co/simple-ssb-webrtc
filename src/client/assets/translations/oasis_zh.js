...
module.exports = {
  zh: {
    ...
    webrtc: "WebRTC",
    webrtcTitle: "WebRTC",
    webrtcDescription: "通过复制粘贴信令进行点对点连接。通过任何外部渠道（聊天、邮件、纸张...）与对方分享代码。",
    webrtcStart: "开始",
    webrtcStartDescription: "选择创建新房间或加入现有房间。",
    webrtcModeLabel: "模式：",
    webrtcModeData: "仅数据（聊天）",
    webrtcModeAV: "音视频通话",
    webrtcCreateRoom: "创建房间",
    webrtcJoinRoom: "加入房间",
    webrtcYourOfferCode: "您的提议代码",
    webrtcOfferCopy: "复制此代码并发送给您的对方：",
    webrtcCopyToClipboard: "复制到剪贴板",
    webrtcPasteAnswer: "现在在下方粘贴对方的应答代码：",
    webrtcPasteAnswerPlaceholder: "在此粘贴对方的应答代码...",
    webrtcConnect: "连接",
    webrtcJoinTitle: "加入房间",
    webrtcPasteOffer: "粘贴您从房间创建者收到的提议代码：",
    webrtcPasteOfferPlaceholder: "在此粘贴提议代码...",
    webrtcGenerateAnswer: "生成应答",
    webrtcYourAnswerCode: "您的应答代码",
    webrtcAnswerCopy: "复制此代码并发送回房间创建者：",
    webrtcWaitingConnection: "等待连接...",
    webrtcMedia: "媒体",
    webrtcLocal: "本地",
    webrtcRemote: "远程",
    webrtcMuteMic: "静音麦克风",
    ...
    webrtcConnected: "已连接",
    webrtcStatus: "状态：",
    webrtcDataChannel: "数据通道：",
    webrtcChat: "数据通道聊天",
    webrtcTypePlaceholder: "输入消息...",
    webrtcSend: "发送",
    webrtcDisconnect: "断开连接",
    password: "密码",
    text: "文本",
    encryptedText: "加密文本",
    iv: "初始化向量 (IV)",
    ...
    modulesWebrtcDescription: "用于点对点音频、视频和数据连接的模块。",
