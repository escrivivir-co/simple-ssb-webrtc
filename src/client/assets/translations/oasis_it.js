...
module.exports = {
  it: {
    ...
    webrtc: "WebRTC",
    webrtcTitle: "WebRTC",
    webrtcDescription: "Connessione peer-to-peer tramite segnalazione copia-incolla. Condividi i codici con il tuo peer tramite qualsiasi canale esterno (chat, email, carta...).",
    webrtcStart: "Avvia",
    webrtcStartDescription: "Scegli se creare una nuova stanza o unirti a una esistente.",
    webrtcModeLabel: "Modalit\u00e0: ",
    webrtcModeData: "Solo dati (chat)",
    webrtcModeAV: "Chiamata Audio/Video",
    webrtcCreateRoom: "Crea Stanza",
    webrtcJoinRoom: "Unisciti a Stanza",
    webrtcYourOfferCode: "Il tuo Codice Offerta",
    webrtcOfferCopy: "Copia questo codice e invialo al tuo peer:",
    webrtcCopyToClipboard: "Copia negli Appunti",
    webrtcPasteAnswer: "Ora incolla il Codice Risposta del tuo peer qui sotto:",
    webrtcPasteAnswerPlaceholder: "Incolla il codice risposta del tuo peer qui...",
    webrtcConnect: "Connetti",
    webrtcJoinTitle: "Unisciti a Stanza",
    webrtcPasteOffer: "Incolla il Codice Offerta ricevuto dal creatore della stanza:",
    webrtcPasteOfferPlaceholder: "Incolla il codice offerta qui...",
    webrtcGenerateAnswer: "Genera Risposta",
    webrtcYourAnswerCode: "Il tuo Codice Risposta",
    webrtcAnswerCopy: "Copia questo codice e invialo al creatore della stanza:",
    webrtcWaitingConnection: "In attesa di connessione...",
    webrtcMedia: "Media",
    webrtcLocal: "Locale",
    webrtcRemote: "Remoto",
    webrtcMuteMic: "Disattiva Micro",
    webrtcHideCam: "Nascondi Camera",
    webrtcConnected: "Connesso",
    webrtcStatus: "Stato: ",
    webrtcDataChannel: "Canale dati: ",
    webrtcChat: "Chat Canale Dati",
    webrtcTypePlaceholder: "Scrivi un messaggio...",
    webrtcSend: "Invia",
    webrtcDisconnect: "Disconnetti",
    password: "Password",
    text: "Text",
    ...
    modulesWebrtcDescription: "Modulo per connessioni audio, video e dati peer-to-peer.",
