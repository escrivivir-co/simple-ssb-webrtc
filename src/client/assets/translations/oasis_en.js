...
module.exports = {
  en: {
    ...
    webrtc: "WebRTC",
    webrtcTitle: "WebRTC",
    webrtcDescription: "Peer-to-peer connection via copy-paste signaling. Share codes with your peer through any external channel (chat, email, paper...).",
    webrtcStart: "Start",
    webrtcStartDescription: "Choose whether to create a new room or join an existing one.",
    webrtcModeLabel: "Mode: ",
    webrtcModeData: "Data Only (chat)",
    webrtcModeAV: "Audio/Video Call",
    webrtcCreateRoom: "Create Room",
    webrtcJoinRoom: "Join Room",
    webrtcYourOfferCode: "Your Offer Code",
    webrtcOfferCopy: "Copy this code and send it to your peer:",
    webrtcCopyToClipboard: "Copy to Clipboard",
    webrtcPasteAnswer: "Now paste your peer's Answer Code below:",
    webrtcPasteAnswerPlaceholder: "Paste the answer code from your peer here...",
    webrtcConnect: "Connect",
    webrtcJoinTitle: "Join Room",
    webrtcPasteOffer: "Paste the Offer Code you received from the room creator:",
    webrtcPasteOfferPlaceholder: "Paste the offer code here...",
    webrtcGenerateAnswer: "Generate Answer",
    webrtcYourAnswerCode: "Your Answer Code",
    webrtcAnswerCopy: "Copy this code and send it back to the room creator:",
    webrtcWaitingConnection: "Waiting for connection...",
    webrtcMedia: "Media",
    webrtcLocal: "Local",
    webrtcRemote: "Remote",
    ...
    webrtcChat: "DataChannel Chat",
    webrtcTypePlaceholder: "Type a message...",
    webrtcSend: "Send",
    ...
    modulesWebrtcDescription: "Module for peer-to-peer audio, video and data connections.",
