...
module.exports = {
  de: {
    ...
    webrtc: "WebRTC",
    webrtcTitle: "WebRTC",
    webrtcDescription: "Peer-to-Peer-Verbindung via Copy-Paste-Signalisierung. Teilen Sie Codes mit Ihrem Partner über einen externen Kanal (Chat, E-Mail, Papier...).",
    webrtcStart: "Start",
    webrtcStartDescription: "Wählen Sie, ob Sie einen neuen Raum erstellen oder einem bestehenden beitreten möchten.",
    webrtcModeLabel: "Modus: ",
    webrtcModeData: "Nur Daten (Chat)",
    webrtcModeAV: "Audio/Video-Anruf",
    webrtcCreateRoom: "Raum erstellen",
    webrtcJoinRoom: "Raum beitreten",
    webrtcYourOfferCode: "Ihr Angebotscode",
    webrtcOfferCopy: "Kopieren Sie diesen Code und senden Sie ihn an Ihren Partner:",
    webrtcCopyToClipboard: "In Zwischenablage kopieren",
    webrtcPasteAnswer: "Fügen Sie jetzt den Antwortcode Ihres Partners unten ein:",
    webrtcPasteAnswerPlaceholder: "Fügen Sie den Antwortcode Ihres Partners hier ein...",
    webrtcConnect: "Verbinden",
    webrtcJoinTitle: "Raum beitreten",
    webrtcPasteOffer: "Fügen Sie den Angebotscode ein, den Sie vom Raumersteller erhalten haben:",
    webrtcPasteOfferPlaceholder: "Fügen Sie den Angebotscode hier ein...",
    webrtcGenerateAnswer: "Antwort generieren",
    webrtcYourAnswerCode: "Ihr Antwortcode",
    webrtcAnswerCopy: "Kopieren Sie diesen Code und senden Sie ihn an den Raumersteller zurück:",
    webrtcWaitingConnection: "Warte auf Verbindung...",
    webrtcMedia: "Medien",
    webrtcLocal: "Lokal",
    webrtcRemote: "Entfernt",
    webrtcMuteMic: "Mikrofon stumm",
    webrtcHideCam: "Kamera verbergen",
    webrtcConnected: "Verbunden",
    webrtcStatus: "Status: ",
    webrtcDataChannel: "Datenkanal: ",
    webrtcChat: "Datenkanal-Chat",
    webrtcTypePlaceholder: "Nachricht eingeben...",
    webrtcSend: "Senden",
    webrtcDisconnect: "Trennen",
    password: "Password",
    text: "Text",
    ...
    modulesWebrtcLabel: "WebRTC",
    modulesWebrtcDescription: "Modul für Peer-to-Peer Audio-, Video- und Datenverbindungen.",
