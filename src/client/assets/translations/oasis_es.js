...
module.exports = {
  es: {
    ...
    webrtc: "WebRTC",
    webrtcTitle: "WebRTC",
    webrtcDescription: "Conexión entre pares mediante señalización por copiar y pegar. Comparte los códigos con tu par a través de cualquier canal externo (chat, email, papel...).",
    webrtcStart: "Inicio",
    webrtcStartDescription: "Elige si crear una nueva sala o unirte a una existente.",
    webrtcModeLabel: "Modo: ",
    webrtcModeData: "Solo datos (chat)",
    webrtcModeAV: "Llamada Audio/Vídeo",
    webrtcCreateRoom: "Crear Sala",
    webrtcJoinRoom: "Unirse a Sala",
    webrtcYourOfferCode: "Tu Código de Oferta",
    webrtcOfferCopy: "Copia este código y envíaselo a tu par:",
    webrtcCopyToClipboard: "Copiar al Portapapeles",
    webrtcPasteAnswer: "Ahora pega el Código de Respuesta de tu par aquí abajo:",
    webrtcPasteAnswerPlaceholder: "Pega el código de respuesta de tu par aquí...",
    webrtcConnect: "Conectar",
    webrtcJoinTitle: "Unirse a Sala",
    webrtcPasteOffer: "Pega el Código de Oferta que recibiste del creador de la sala:",
    webrtcPasteOfferPlaceholder: "Pega el código de oferta aquí...",
    webrtcGenerateAnswer: "Generar Respuesta",
    webrtcYourAnswerCode: "Tu Código de Respuesta",
    webrtcAnswerCopy: "Copia este código y envíaselo al creador de la sala:",
    webrtcWaitingConnection: "Esperando conexión...",
    webrtcMedia: "Medios",
    webrtcLocal: "Local",
    webrtcRemote: "Remoto",
    webrtcMuteMic: "Silenciar Micro",
    webrtcHideCam: "Ocultar Cámara",
    webrtcConnected: "Conectado",
    webrtcStatus: "Estado: ",
    webrtcDataChannel: "Canal de datos: ",
    webrtcChat: "Chat por Canal de Datos",
    webrtcTypePlaceholder: "Escribe un mensaje...",
    webrtcSend: "Enviar",
    webrtcDisconnect: "Desconectar",
    password: "Contraseña",
    text: "Texto",
    ...
    modulesWebrtcDescription: "Módulo para conexiones de audio, vídeo y datos entre pares.",
